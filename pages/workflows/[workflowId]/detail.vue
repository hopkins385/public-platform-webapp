  ...
  <div class="grid grid-cols-4">
    <div class="col-span-3">
      <div class="space-x-4 px-10 pt-5">
        <Button variant="outline" class="text-xs" size="sm" @click="up">Up</Button>
        <Button variant="outline" class="text-xs" size="sm" @click="down">Down</Button>
      </div>
      <div class="flex flex-col p-4 text-xs">
        ...
        >
          <div class="">
            <div id="header" class="py-2 font-semibold underline">
              {{ step.name }}
            </div>
            <div id="content">
