...
<template>
  <SectionContainer>
    ...
    <BoxContainer class="mt-5">
      ...
      <p class="w-fit text-sm">{{ organization.name }}</p>
      <p class="mt-4 w-fit text-sm opacity-50">ID: {{ organization.id }}</p>
    </BoxContainer>
    <BoxContainer class="mt-5">
    ...
    <BoxContainer class="mt-5">
      ...
      <ul>
        <li v-for="prj in projects" :key="prj.project.id" class="w-fit text-sm">
          {{ prj.project?.name }}
        </li>
      </ul>
    </BoxContainer>
